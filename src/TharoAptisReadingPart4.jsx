...
const DATA = [
  {
    ...
    en: 'Who enjoyed the last day',
    vi: 'Ai đã tận hưởng ngày cuối cùng',
    answer: 'A',
  },
  {
    topic: 'MUSIC FESTIVAL',
    en: 'Who disliked the bad weather?',
    vi: 'Ai không thích thời tiết xấu?',
    answer: 'A',
  },
  {
    topic: 'MUSIC FESTIVAL',
    en: 'Who was disappointed with the festival?',
    vi: 'Ai đã thất vọng với lễ hội?',
    answer: 'B',
  },
  {
    topic: 'MUSIC FESTIVAL',
    en: 'Who enjoyed the music at the event?',
    vi: 'Ai đã thưởng thức âm nhạc tại sự kiện?',
    answer: 'C',
  },
  {
    topic: 'MUSIC FESTIVAL',
    en: 'Who found the ticket prices expensive?',
    vi: 'Ai thấy giá vé đắt?',
    answer: 'C',
  },
  {
    topic: 'MUSIC FESTIVAL',
    en: 'Who liked to meet old friends?',
    vi: 'Ai thích gặp gỡ bạn bè cũ?',
    answer: 'D',
  },
  {
    topic: 'MUSIC FESTIVAL',
    en: 'Who didn\'t like the venue?',
    vi: 'Ai không thích địa điểm tổ chức?',
    answer: 'D',
  },
  {
    topic: 'EXTREME SPORTS',
    en: 'Who finds training before participating important?',
    vi: 'Ai thấy việc tập luyện trước khi tham gia là quan trọng?',
    answer: 'A',
  },
  {
    topic: 'EXTREME SPORTS',
    en: 'Who likes traditional sports like swimming?',
    vi: 'Ai thích các môn thể thao truyền thống như bơi lội?',
    answer: 'B',
  },
  {
    topic: 'EXTREME SPORTS',
    en: 'Who still likes extreme sports after playing once?',
    vi: 'Ai vẫn thích các môn thể thao mạo hiểm sau khi chơi một lần?',
    answer: 'B',
  },
  {
    topic: 'EXTREME SPORTS',
    en: 'Who enjoys nature?',
    vi: 'Ai yêu thích thiên nhiên?',
    answer: 'C',
  },
  {
    topic: 'EXTREME SPORTS',
    en: 'Who wants to play more extreme sports?',
    vi: 'Ai muốn chơi thêm các môn thể thao mạo hiểm?',
    answer: 'C',
  },
  {
    topic: 'EXTREME SPORTS',
    en: 'Who finds extreme sports unimportant?',
    vi: 'Ai thấy các môn thể thao mạo hiểm không quan trọng?',
    answer: 'D',
  },
  {
    topic: 'EXTREME SPORTS',
    en: 'Who always avoids playing extreme sports?',
    vi: 'Ai luôn tránh chơi các môn thể thao mạo hiểm?',
    answer: 'D',
  },
  {
    topic: 'TECHNOLOGY IN CHILDHOOD',
    en: 'Who loved watching technology shows as a child?',
    vi: 'Ai thích xem các chương trình công nghệ khi còn nhỏ?',
    answer: 'A',
  },
  {
    topic: 'TECHNOLOGY IN CHILDHOOD',
    en: 'Who now prefers online learning?',
    vi: 'Ai bây giờ thích học trực tuyến hơn?',
    answer: 'A',
  },
  {
    topic: 'TECHNOLOGY IN CHILDHOOD',
    en: 'Who loved playing with toy robots as a child?',
    vi: 'Ai thích chơi với robot đồ chơi khi còn nhỏ?',
    answer: 'B',
  },
  {
    topic: 'TECHNOLOGY IN CHILDHOOD',
    en: 'Who loved reading science magazines in the past?',
    vi: 'Ai đã thích đọc tạp chí khoa học trong quá khứ?',
    answer: 'C',
  },
  {
    topic: 'TECHNOLOGY IN CHILDHOOD',
    en: 'Who now enjoys developing apps?',
    vi: 'Ai bây giờ thích phát triển ứng dụng?',
    answer: 'C',
  },
  {
    topic: 'TECHNOLOGY IN CHILDHOOD',
    en: 'Who enjoys coding with family?',
    vi: 'Ai thích lập trình cùng gia đình?',
    answer: 'D',
  },
  {
    topic: 'TECHNOLOGY IN CHILDHOOD',
    en: 'Who finds modern tools more accessible?',
    vi: 'Ai thấy các công cụ hiện đại dễ tiếp cận hơn?',
    answer: 'D',
  },
  {
    topic: 'WORK - LIFE BALANCE',
    en: 'Who enjoys family time with board games?',
    vi: 'Ai thích thời gian gia đình với các trò chơi cờ bàn?',
    answer: 'A',
  },
  {
    topic: 'WORK - LIFE BALANCE',
    en: 'Who finds modern schedules more flexible?',
    vi: 'Ai thấy lịch trình hiện đại linh hoạt hơn?',
    answer: 'A',
  },
  {
    topic: 'WORK - LIFE BALANCE',
    en: 'Who loved organizing pretend offices as a child?',
    vi: 'Ai thích tổ chức văn phòng giả vờ khi còn nhỏ?',
    answer: 'B',
  },
  {
    topic: 'WORK - LIFE BALANCE',
    en: 'Who loved reading about careers as a child?',
    vi: 'Ai thích đọc về các ngành nghề khi còn nhỏ?',
    answer: 'C',
  },
  {
    topic: 'WORK - LIFE BALANCE',
    en: 'Who now enjoys productivity apps?',
    vi: 'Ai bây giờ thích các ứng dụng năng suất?',
    answer: 'C',
  },
  {
    topic: 'WORK - LIFE BALANCE',
    en: 'Who loved outdoor play as a child?',
    vi: 'Ai thích chơi ngoài trời khi còn nhỏ?',
    answer: 'D',
  },
  {
    topic: 'WORK - LIFE BALANCE',
    en: 'Who now prefers mindfulness practices?',
    vi: 'Ai bây giờ thích các phương pháp thực hành chánh niệm hơn?',
    answer: 'D',
  },
  {
    topic: 'CHILDHOOD',
    en: 'Who liked playing with children?',
    vi: 'Ai thích chơi với trẻ em?',
    answer: 'A',
  },
  {
    topic: 'CHILDHOOD',
    en: 'Who liked art when they were children?',
    vi: 'Ai thích nghệ thuật khi còn nhỏ?',
    answer: 'D',
  },
  {
    topic: 'CHILDHOOD',
    en: 'Who finds the games nowadays much more difficult?',
    vi: 'Ai thấy các trò chơi ngày nay khó hơn nhiều?',
    answer: 'A',
  },
  {
    topic: 'CHILDHOOD',
    en: 'Who likes modern games when they grow up?',
    vi: 'Ai thích các trò chơi hiện đại khi lớn lên?',
    answer: 'C',
  },
  {
    topic: 'CHILDHOOD',
    en: 'Who liked playing with friends when they were children?',
    vi: 'Ai thích chơi với bạn bè khi còn nhỏ?',
    answer: 'B',
  },
  {
    topic: 'CHILDHOOD',
    en: 'Who liked reading books when they were children?',
    vi: 'Ai thích đọc sách khi còn nhỏ?',
    answer: 'C',
  },
  {
    topic: 'CHILDHOOD',
    en: 'Who liked going out to play when they were children?',
    vi: 'Ai thích ra ngoài chơi khi còn nhỏ?',
    answer: 'D',
  },
  {
